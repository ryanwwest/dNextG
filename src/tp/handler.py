...
from templater import get_node_number
...
class D5gTransactionHandler(TransactionHandler):
    ...
    def apply(self, transaction, context):
        ...
        num_nodes = len(payload.tested_nodes) + 1
        cur_node_number = get_node_number()
        state = D5gNodeState(context, transaction.header.batcher_public_key, num_nodes, cur_node_number)
